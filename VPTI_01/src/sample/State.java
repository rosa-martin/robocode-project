...
public class State {
    ...
    public double[] toArray() {
        ArrayList<Double> out = new ArrayList<Double>(Arrays.asList(new Double[]{x, y, heading, gunHeading, radarHeading, distRemaining, velocity, energy, 
            enemyCount, bulletHeading, bulletBearing, bulletPower, bulletVelocity}));
